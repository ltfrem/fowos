...
function wo_num() {
  ...
  let answer = "";
  let regex = "";
  document.getElementById("wo_num_ques").innerHTML =
...
function fo_num() {
  ...
  document.getElementById("fo_num_ques").innerHTML =
